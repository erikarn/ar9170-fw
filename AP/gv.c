...
struct zsDmaDesc* zgDnQCurrentDescPtr;
struct zsDmaQueue zgRTQ;
u8_t zgDnQTUCount;
u8_t zgRTQTUCount;
u8_t zgPendingTUCount;
...
volatile u8_t zgRCBaGrand = 1;
volatile u16_t zgRCBaMacAddr[3];
volatile u16_t zgRCBaPhyCtrl[2];
volatile u16_t zgRCBaMacCtrl;
volatile u32_t zgRCBaMPDUCnt = 0;
volatile u32_t zgRCBaErrorCnt = 0;
